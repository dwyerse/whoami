...
const Clues: Clue[] = [
  ...
  },
  {
    ...
    clue2:
      "I attended Chabot College and California State University, Sacramento but never graduated from college.",
    clue3: "I voiced the character Woody in the 'Toy Story' franchise.",
    clue4:
      "I starred in the film 'Cast Away' and my co-star was a volleyball named Wilson.",
  ...
  },
  {
    ...
    clue2:
      "I come from a family of actors and filmmakers; my father was an underground filmmaker, and my mother, Elsie Ford, was an actress.",
    clue3:
      "I played the lead role in the 'Iron Man' and 'Sherlock Holmes' franchises.",
  ...
  },
  {
    ...
    clue2:
      "I was discovered by a talent scout when I was 14 while on vacation in New York City with my family.",
  ...
  },
  {
    ...
    clue2:
      "I was named after the artist Leonardo da Vinci because my pregnant mother felt me kick while she was looking at a painting of the famous artist.",
    clue3:
      "I won the Academy Award for Best Actor for my role in 'The Revenant'.",
  ...
  },
  {
    ...
    clue2:
      "I graduated from Vassar College with a degree in Drama and went on to earn a Master of Fine Arts degree from Yale School of Drama.",
  ...
  },
  {
    ...
    clue1: "I was born in Los Angeles, California.",
    clue2:
      "I dropped out of college to pursue my acting career and worked as a fashion model before that.",
    clue3: "I played Lara Croft in the 'Tomb Raider' franchise.",
    clue4:
      "I won the Academy Award for Best Supporting Actress for my role in 'Girl, Interrupted'.",
  ...
  },
  {
    ...
    clue2:
      "I dropped out of college two weeks before graduation to move to California and pursue my acting career.",
    clue3: "I played the lead role in the film 'Fight Club'.",
    clue4:
      "I won the Academy Award for Best Supporting Actor for my role in 'Once Upon a Time in Hollywood'.",
    clue5:
      "I starred in the films 'Ocean's Eleven', 'Mr. & Mrs. Smith', and 'Inglourious Basterds'.",
  },
  {
    name: "Anne Hathaway",
    clue1: "I was born in Brooklyn, New York City.",
    clue2:
      "I was the first teenager admitted to the Barrow Group Theater Company's acting program.",
    clue3: "I played the role of Mia Thermopolis in 'The Princess Diaries'.",
    clue4:
      "I won the Academy Award for Best Supporting Actress for my role in 'Les Misérables'.",
  ...
  },
  {
    ...
    clue2:
      "I come from a family of actors; my mother is a former theater company artistic director and my uncle is an actor.",
    clue3:
      "I played the role of Captain America in the Marvel Cinematic Universe.",
    clue4: "I starred in the films 'Snowpiercer' and 'Knives Out'.",
    clue5:
      "I played the role of Johnny Storm/Human Torch in the 'Fantastic Four' films.",
  },
];
